...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  ...
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    it('should return keys and drinks', () => {
    ...
    it('If receives a string parameter in order, should return in object.consumption a array with the same string gived by parameter in order', () => {
      objetoRetornado.order('coxinha'),
        expect(objetoRetornado).toContain('coxinha');
    })
    ...
    // ```
    it('Should return an array (objetoRetornado.Consumption) with the ordered itens', () => {
      objetoRetornado.order("coxinha");
    ...
    it('If acepts itens with the same name', () => {
      objetoRetornado.order('coxinha');
      objetoRetornado.order('agua');
      objetoRetornado.order('coxinha');
    ...
    // ```
    it('Should return the samw value as expected', () => {
